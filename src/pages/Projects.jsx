    ...
    return (
        <div className='wrapper overflow-clip bg-stone-100  '>
            ...
            <section className=' flex items-center justify-center flex-col gap-4 py-10 '>
                ...
                <h1 className='text-[60px] leading-[60px] text-transparent bg-clip-text bg-gradient-to-br from-black to-stone-500/70 font-extrabold mb-2 tracking-tighter'>{Greetings}</h1>
                <p className='text-sm text-black max-w-[500px] text-center tracking-tight '>{AboutMe}</p>
            </section>
            ...
            <section className='w-full'>
                ...
                <div className='gridRespo w-full m-auto px-3 overflow-clip'>
                    {ProjectModel.map((project) => (
                        <Link to={`/`} key={project.id} className={` group rounded-sm h-[180px] w-full overflow-clip flex items-center justify-center bg-gradient-to-br from-stone-300 to-stone-100  `} >
