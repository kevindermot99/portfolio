...
function Projects() {
    ...
    return (
        <div>
            ...
            <section className='flex items-center justify-center flex-col my-10 pt-10 pb-16 sticky top-[110px] -z-[2]'>
            ...
            <section className='bg-white w-full max-w-[1150px] grid grid-cols-2 gap-1 m-auto px-3'>
