    ...
    <div className="wrapper overflow-clip bg-stone-100  ">
      ...
      <section className="w-full">
        <p className=" text-black/80 mt-4 px-4 pb-8 flex items-center justify-start flex-col max-w-[1200px] mx-auto ">
          <span className="text-2xl font-bold tracking-tighter">Full-stack Projects</span>
          <span className="text-sm font-medium text-black max-w-[500px] text-center tracking-tight">I have Created {ProjectModel.length} full-stack projects so far</span>
        </p>
      ...
      <section className="w-full mt-12">
        <p className=" text-black/80 mt-4 px-4 pb-8 flex items-center justify-start flex-col max-w-[1200px] mx-auto ">
          <span className="text-2xl font-bold tracking-tighter">Front-end Projects</span>
          <span className="text-sm font-medium text-black max-w-[500px] text-center tracking-tight">I have Created {ProjectModel.length} front-end only projects so far</span>
        </p>
        <div className="gridRespo w-full m-auto px-3 overflow-clip">
          {ProjectModel.map((project) => (
            <Link
