...
`;
  return (
    <div className="wrapper overflow-clip bg-light-body dark:bg-dark-body text-black/90 dark:text-white/80  ">
      ...
      {/* Functional Projects */}
      <section className="w-full h-fit flex items-start justify-strat flex-col gap-2 px-20 max-md:px-5 pt-32 ">
        <div className="grid grid-cols-2 max-md:grid-cols-1 gap-6 mb-20 max-md:mb-10 max-md:gap-5">
          <Fade triggerOnce>
            ...
            <p className="text-base leading-6 opacity-70">
              Here, you’ll find projects that not only look great but also works. This includes everything from full stack web apps to functional React-based apps that perform as intended.
            </p>
          </Fade>
        </div>
