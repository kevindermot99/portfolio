...
function Work() {
  return (
    <div className="wrapper overflow-clip bg-light-body dark:bg-dark-body text-black/90 dark:text-white/80  ">
      ...
      {/* Projects */}
      <section className="w-full h-fit flex items-start justify-strat flex-col gap-2 py-20 px-20 max-md:px-10 pt-32 ">
        <div className="grid grid-cols-2 max-md:grid-cols-1 gap-6 mb-20 max-md:gap-5">
