      ...
      <section className="w-full h-fit grid grid-cols-2 max-md:grid-cols-1 gap-10 py-20 px-20 max-md:px-5 pt-32 ">
        ...
        <div className="flex flex-col gap-4 mb-20 max-md:mb-10 max-md:gap-5">
          ...
          <p className="text-base leading-6 max-w-full text-justify text-black/70 dark:text-white/40">
            ...
            improved as time flew by. Eventually, I moved on to JavaScript, then
            React, and Next.js and as of today, I have skills to bring almost
            any idea that comes to my mind to life.
          </p>
          <p className="text-base leading-6 max-w-full text-justify text-black/70 dark:text-white/40">
            ...
            with to-do list apps or other YouTube tutorial copy-paste projects,
            but I didn't. What I want is to show that I can create solutions to
            real problems.
          </p>
          <p className="text-base leading-6 max-w-full text-justify text-black/70 dark:text-white/40">
            Currently pursuing my Bachelor's degree in Software Engineering
            at the African Leadership University (ALU) 2024 - 2027.
          </p>
