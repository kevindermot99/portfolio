...
function Navbar() {
  ...
  return (
    <div className="w-[250px] bg-orange-400/0 flex flex-col items-start justify-between h-full text-dark_color dark:text-light_color fixed z-10 top-0 left-0 px-11 py-8 max-lg:fixed max-lg:top-0 max-lg:left-0 max-lg:flex-row">
