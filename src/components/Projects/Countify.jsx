...
function Countify() {
  ...
  return (
    ...
    >
      ...
      {/* screenshot 1 */}
      <div
        className={`w-[100%] select-none pointer-events-none h-fit px-3 opacity-0 group-hover:opacity-100 absolute left-0 right-0 mx-auto top-[100%] group-hover:top-[35%] delay-150 transition-all duration-500 ease-in-out`}
      >
        <div
      ...
      <div
        className={`w-full select-none pointer-events-none flex items-start justify-between gap-0 h-fit px-3 opacity-0 group-hover:opacity-100 absolute left-0 right-0 mx-auto top-[100%] group-hover:top-[59%] delay-150 transition-all duration-500 ease-in-out overflow-x-auto invisible_scroll`}
      >
        <div
          className={`w-full bg-white dark:bg-[#37373b] rounded-2xl flex items-start justify-between gap-0 h-fit p-3 overflow-x-auto invisible_scroll`}
        >
