...
function Countify() {
  ...
  return (
    <div className="flex items-start flex-col">
      ...
      >
        <div
          className={`flex flex-col gap-2 select-none pointer-events-none xl:group-hover:scale-75 max-xl:scale-75 xl:group-hover:translate-y-[-105px] max-xl:translate-y-[-105px] transition-all duration-500 `}
        >
          <div className="flex items-center gap-2 ">
            ...
            />
            <h1 className=" font-bold text-3xl text-dark_color dark:text-light_color tracking-wide xl:text-dark_color/45 xl:dark:text-light_color/45 xl:group-hover:text-dark_color">
              Countify
            </h1>
          </div>
        </div>
