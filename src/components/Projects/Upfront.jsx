...
function Upfront() {
  ...
  return (
    <Link
      to="/"
      className="w-full h-[312px] bg-stone-200/80 dark:bg-card_color_dark transition group  rounded-3xl relative flex items-center justify-center flex-col overflow-hidden"
    >
      <div
