  ...
  return (
    <div className="flex items-start flex-col">
      <Link
        ...
        target="_blank"
        className="w-full h-[312px] bg-[#f2f2f2] dark:bg-card_color_dark/70 transition group  rounded-3xl relative flex items-center justify-center flex-col overflow-hidden"
      >
        <div
